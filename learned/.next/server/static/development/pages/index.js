...
_src_firebase_firebase__WEBPACK_IMPORTED_MODULE_2__["default"].collection('user').get().then(function (querySnapshot) {
  var users = [];
  querySnapshot.forEach(function (doc) {
    users.push(Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({
      id: doc.id
    }, doc.data()));
  });
  console.log(users);
