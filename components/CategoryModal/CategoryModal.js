...
function CategoryModal(props) {
    ...
    // }
    const cardStyle = {display: 'block', margin: '0', height: cardHeight, width: cardWidth, cursor: 'pointer'}
    const selectedStyle = {display: 'block', margin: '0', height: cardHeight, width: cardWidth, cursor: 'pointer',border:"1px solid black", boxShadow:"0px 4px 50px -4px rgba(46,54,199,1)", transform:"scale(1.01)"}
    const { classes } = props;
    return (
        <div>
            <Dialog fullScreen open={props.open} onClose={handleClose} TransitionComponent={Transition}>
                ...
                <GridList cellHeight={200} style={{ display: 'flex', flexFlow: 'row wrap', alignItems: 'center', justifyContent: 'center', padding: '20px 160px 0 160px' }}>
                    ...
                    <GridListTile cols={cardSize} style={{ display: 'block', height: cardHeight, width: "840px", margin: '0' }}  >
                        ...
                        <GridListTileBar title="Please Pick 3 Categories that you are interested in" />
                    </GridListTile>
                    ...
                    <GridListTile cols={cardSize}  style={props.categories.includes("Music") ? selectedStyle : cardStyle} onClick={() => { props.handleAdd("Music"); setR(r+1) }} >
                    ...
                    <GridListTile cols={cardSize} style={props.categories.includes("Business") ? selectedStyle : cardStyle} onClick={() => { props.handleAdd("Business");setR(r+1) }} >
                    ...
                    <GridListTile cols={cardSize} style={props.categories.includes("Design") ? selectedStyle : cardStyle} onClick={() => { props.handleAdd("Design"); setR(r+1) }}>
                    ...
                    <GridListTile cols={cardSize} style={props.categories.includes("Development") ? selectedStyle : cardStyle} onClick={() => { props.handleAdd("Development"); setR(r+1) }}>
                    ...
                    <GridListTile cols={cardSize} style={props.categories.includes("Health & Fitness") ? selectedStyle : cardStyle} onClick={() => { props.handleAdd("Health & Fitness"); setR(r+1) }}>
                    ...
                    <GridListTile cols={cardSize} style={props.categories.includes("IT & Software") ? selectedStyle : cardStyle} onClick={() => { props.handleAdd("IT & Software"); setR(r+1) }}>
                    ...
                    <GridListTile cols={cardSize} style={props.categories.includes("Lifestyle") ? selectedStyle : cardStyle} onClick={() => { props.handleAdd("Lifestyle"); setR(r+1) }}>
                    ...
                    <GridListTile cols={cardSize} style={props.categories.includes("Marketing") ? selectedStyle : cardStyle} onClick={() => { props.handleAdd("Marketing"); setR(r+1) }}>
                    ...
                    <GridListTile cols={cardSize} style={props.categories.includes("Office") ? selectedStyle : cardStyle} onClick={() => {props.handleAdd("Office"); setR(r+1) }}>
                    ...
                    <GridListTile cols={cardSize} style={props.categories.includes("Personal Development") ? selectedStyle : cardStyle} onClick={() => { props.handleAdd("Personal Development"); setR(r+1) }}>
                    ...
                    <GridListTile cols={cardSize} style={props.categories.includes("Photography") ? selectedStyle : cardStyle} onClick={() => { props.handleAdd("Photography"); setR(r+1) }}>
                    ...
                    <GridListTile cols={cardSize} style={props.categories.includes("Teaching & Academics") ? selectedStyle : cardStyle} onClick={() => { props.handleAdd("Teaching & Academics"); setR(r+1) }}>
